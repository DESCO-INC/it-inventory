    ...
    <div id="edit-modal"
        ...
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
            ...
            <form id="edit-form" method="POST" class="mt-4">
                ...
                <x-input label="Name" id="edit-name" name="name" placeholder="Ex: Solidworks"
                    class="w-full mb-2" required />
                <x-input label="Supplier" id="edit-supplier" name="supplier" placeholder="Ex: Desco"
                    class="w-full mb-2" required />
